...
def main():
    ...
    hap1_shared_out = out_prefix + ".shared.hap1.indel"    # $prefix.s.bam.ds.shared.hap1.indel
    hap2_shared_out = out_prefix + ".shared.hap2.indel"    # $prefix.s.bam.ds.shared.hap2.indel
